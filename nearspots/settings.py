"""
Django settings for nearspots project.
...
SECRET_KEY = 'django-insecure-dyxvr7-#p$(1^irb)g1-2%c!x)gmn36e2%1h3j9%l27e@3t!)w'
...
WSGI_APPLICATION = 'nearspots.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'nearspots' / 'db.sqlite3',
        'OPTIONS': {
